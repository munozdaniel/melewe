            ...
            <div class="span3 col-md-3">
                ...
                <nav id="options" class="work-nav">
                    <ul id="filters" class="option-set" data-option-key="filter">
                        ...
                        <li><a href="#filter" data-option-value=".design">Villa La Angostura</a></li>
                        <li><a href="#filter" data-option-value=".photography">Caviahue</a></li>
                        <li><a href="#filter" data-option-value=".video">Moquehue</a></li>
                        <li><a href="#filter" data-option-value=".video">San Martin de los Andes</a></li>
                        <li><a href="#filter" data-option-value=".video">Las Grutas</a></li>
                    </ul>
                </nav>
                <!-- End Filter -->
            </div>
